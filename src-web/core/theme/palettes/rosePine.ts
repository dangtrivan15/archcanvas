...
export const rosePine: ThemePalette = {
  ...
  light: {
    ...
    nsIntegrationBg: '#eef6f6',
    nsIntegrationBorder: '#56949f',
    nsSecurityBg: '#fceef2',
    nsSecurityBorder: '#b4637a',
    nsObservabilityBg: '#f4eef8',
    nsObservabilityBorder: '#907aa9',
    nsAiBg: '#eef0fa',
    nsAiBorder: '#907aa9',
  ...
  dark: {
    ...
    nsIntegrationBg: '#1a2a2e',
    nsIntegrationBorder: '#9ccfd8',
    nsSecurityBg: '#2e1a24',
    nsSecurityBorder: '#eb6f92',
    nsObservabilityBg: '#261a34',
    nsObservabilityBorder: '#c4a7e7',
    nsAiBg: '#1e1c36',
    nsAiBorder: '#c4a7e7',
