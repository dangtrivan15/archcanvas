...
This command **requires** the project directory as an argument via `/Users/vandang/GitProjects/archcanvas`.

**Example:** `/create-spec generations/my-app`

**Output location:** `/Users/vandang/GitProjects/archcanvas/.autoforge/prompts/app_spec.txt` and `/Users/vandang/GitProjects/archcanvas/.autoforge/prompts/initializer_prompt.md`

If `/Users/vandang/GitProjects/archcanvas` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `/Users/vandang/GitProjects/archcanvas/.autoforge/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `/Users/vandang/GitProjects/archcanvas/.autoforge/prompts/app_spec.txt`
...
**Output path:** `/Users/vandang/GitProjects/archcanvas/.autoforge/prompts/initializer_prompt.md`
...
**Output path:** `/Users/vandang/GitProjects/archcanvas/.autoforge/prompts/.spec_status.json`
...
> "Your specification files have been created in `/Users/vandang/GitProjects/archcanvas/.autoforge/prompts/`!
>
> **Files created:**
> - `/Users/vandang/GitProjects/archcanvas/.autoforge/prompts/app_spec.txt`
> - `/Users/vandang/GitProjects/archcanvas/.autoforge/prompts/initializer_prompt.md`
>
