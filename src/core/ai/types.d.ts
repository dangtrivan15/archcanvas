...
export type ChatEvent = TextEvent | ToolCallEvent | ToolResultEvent | ThinkingEvent | PermissionRequestEvent | AskUserQuestionEvent | StatusEvent | RateLimitEvent | DoneEvent | ChatErrorEvent;
...
export type ClientMessage = ChatClientMessage | AbortClientMessage | LoadHistoryClientMessage | PermissionResponseClientMessage | QuestionResponseClientMessage | SetPermissionModeClientMessage | SetEffortClientMessage;
